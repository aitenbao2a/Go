...
VALUES
(1, 'Grand Palace', 'Luxury hotel with sea view', '123 Beach Road', 'Miami', 'USA', 5, 25.774, -80.19, 'Pool,Spa,WiFi', 'grand1.jpg,grand2.jpg', 200.00),
(2, 'City Inn', 'Comfortable city hotel', '456 Downtown St', 'New York', 'USA', 4, 40.7128, -74.0060, 'WiFi,Gym,Restaurant', 'city1.jpg,city2.jpg', 120.00),
(3, N'Khách sạn Sài Gòn Panorama', N'Khách sạn sang trọng ở trung tâm thành phố', N'79 Đường Nguyễn Huệ', N'Hồ Chí Minh', N'Việt Nam', 5, 10.7760, 106.7019, 'Pool,Spa,Gym,Restaurant', 'saigon1.jpg,saigon2.jpg', 185.00),
(4, N'Hà Nội Cổ Kính Inn', N'Nằm trong khu phố cổ, gần Hồ Gươm', N'36 Hàng Bông', N'Hà Nội', N'Việt Nam', 4, 21.0285, 105.8542, 'WiFi,Breakfast,TourDesk', 'hanoi1.jpg,hanoi2.jpg', 95.00),
(5, N'Resort Biển Đà Nẵng', N'Khu nghỉ dưỡng sát biển, tầm nhìn tuyệt đẹp', N'516 Võ Nguyên Giáp', N'Đà Nẵng', N'Việt Nam', 5, 16.0680, 108.2210, 'Pool,PrivateBeach,Spa,Bar', 'danang1.jpg,danang2.jpg', 250.00),
(6, N'Khách sạn Phố Hội', N'Nét kiến trúc truyền thống ở phố cổ', N'12 Lê Lợi', N'Hội An', N'Việt Nam', 4, 15.8794, 108.3364, 'Terrace,BikeRental,Restaurant', 'hoian1.jpg,hoian2.jpg', 110.00),
(7, N'Huế Imperial', N'Khách sạn lịch sử gần Đại Nội', N'150 Hùng Vương', N'Huế', N'Việt Nam', 4, 16.4637, 107.5841, 'Restaurant,Gym,Sauna', 'hue1.jpg,hue2.jpg', 135.00),
(8, N'Nha Trang Ocean View', N'Khách sạn hiện đại nhìn ra biển', N'22 Trần Phú', N'Nha Trang', N'Việt Nam', 4, 12.2450, 109.1917, 'Pool,Bar,WiFi', 'ntrang1.jpg,ntrang2.jpg', 105.00),
(9, N'Phú Quốc Marina', N'Khu nghỉ dưỡng biệt lập yên tĩnh', N'Ấp 4, Bãi Dài', N'Phú Quốc', N'Việt Nam', 5, 10.2300, 103.9500, 'Pool,Spa,WaterSports', 'pq1.jpg,pq2.jpg', 220.00),
(10, N'Đà Lạt Mộng Mơ', N'Khách sạn kiểu Pháp lãng mạn', N'10 Triệu Việt Vương', N'Đà Lạt', N'Việt Nam', 4, 11.9404, 108.4586, 'Fireplace,Garden,Cafe', 'dalat1.jpg,dalat2.jpg', 80.00),
(11, N'Cần Thơ Mekong Oasis', N'Nằm bên bờ sông Hậu', N'118 Hai Bà Trưng', N'Cần Thơ', N'Việt Nam', 3, 10.0337, 105.7865, 'RiverView,BoatTours,Breakfast', 'ctho1.jpg,ctho2.jpg', 65.00),
(12, N'Hạ Long Bay View', N'Khách sạn có ban công nhìn ra vịnh', N'Khu Du lịch Bãi Cháy', N'Hạ Long', N'Việt Nam', 5, 20.9576, 107.0322, 'RooftopBar,Pool,Spa', 'hl1.jpg,hl2.jpg', 195.00),
(13, N'Khách sạn Kim Long', N'Tiện nghi, gần trung tâm mua sắm', N'234 Trần Hưng Đạo', N'Hồ Chí Minh', N'Việt Nam', 3, 10.7620, 106.6800, 'WiFi,Parking,AC', 'hcm3.jpg,hcm4.jpg', 55.00),
(14, N'Sapa Retreat', N'View núi non tuyệt đẹp, không gian ấm cúng', N'Fansipan Legend', N'Sapa', N'Việt Nam', 4, 22.3667, 103.8433, 'Hammam,Heating,Hiking', 'sapa1.jpg,sapa2.jpg', 145.00),
(15, N'Vũng Tàu Lighthouse', N'Khách sạn gia đình gần bãi biển', N'120 Hạ Long', N'Vũng Tàu', N'Việt Nam', 3, 10.3444, 107.0862, 'KidsClub,BeachAccess', 'vt1.jpg,vt2.jpg', 75.00),
(16, N'Quy Nhơn Seafront', N'Khách sạn 4 sao mới, đối diện biển', N'20 Xuân Diệu', N'Quy Nhơn', N'Việt Nam', 4, 13.7845, 109.2270, 'Pool,Gym,Seaview', 'qn1.jpg,qn2.jpg', 115.00),
(17, N'Thanh Hóa Sunset', N'Khách sạn nghỉ dưỡng ven biển Sầm Sơn', N'Bãi B, Sầm Sơn', N'Thanh Hóa', N'Việt Nam', 3, 19.8000, 106.0000, 'Breakfast,Terrace', 'th1.jpg,th2.jpg', 70.00),
(18, N'Tuy Hòa Pearl', N'Khách sạn nhỏ xinh, phục vụ chuyên nghiệp', N'200 Độc Lập', N'Tuy Hòa', N'Việt Nam', 3, 13.0800, 109.3000, 'FreeParking,Laundry', 'th2.jpg,th3.jpg', 60.00),
(19, N'Bình Thuận Ocean Star', N'Resort lãng mạn tại Mũi Né', N'Mũi Né, Phan Thiết', N'Bình Thuận', N'Việt Nam', 5, 10.9344, 108.2830, 'PrivatePool,Bar,Massage', 'bt1.jpg,bt2.jpg', 280.00),
(20, N'Hà Giang Grand View', N'Khách sạn có tầm nhìn ra đồi núi', N'Tổ 1, Phố Cổ Đồng Văn', N'Hà Giang', N'Việt Nam', 3, 23.2800, 105.3500, 'MountainView,Heating', 'hg1.jpg,hg2.jpg', 90.00),
(21, N'Ninh Bình Lotus', N'Khách sạn gần khu du lịch Tràng An', N'Thôn 4, Hoa Lư', N'Ninh Bình', N'Việt Nam', 4, 20.2500, 105.9000, 'BikeRental,Garden,Restaurant', 'nb1.jpg,nb2.jpg', 118.00),
(22, N'Bạc Liêu Heritage', N'Khách sạn tiêu chuẩn quốc tế', N'12 Phạm Văn Đồng', N'Bạc Liêu', N'Việt Nam', 3, 9.2800, 105.7300, 'BusinessCenter,WiFi', 'bl1.jpg,bl2.jpg', 68.00),
(23, 'Tokyo Sky Tower Hotel', 'Modern design with panoramic city views', '5-1 Marunouchi, Chiyoda', 'Tokyo', 'Japan', 5, 35.6895, 139.6917, 'Spa,Bar,Pool,Concierge', 'tokyo1.jpg,tokyo2.jpg', 320.00),
(24, 'Rome Historic Stay', 'Charming hotel near the Colosseum', 'Via Cavour 101', 'Rome', 'Italy', 4, 41.9028, 12.4964, 'Breakfast,Terrace,WiFi', 'rome1.jpg,rome2.jpg', 160.00),
(25, 'Bangkok Riverside', 'Budget hotel by Chao Phraya River', 'Soi 13 Charoen Krung', 'Bangkok', 'Thailand', 3, 13.7563, 100.5018, 'FerryAccess,Laundry,AC', 'bkk1.jpg,bkk2.jpg', 45.00),
(26, 'Dubai Marina Resort', 'Exclusive stay on the waterfront', 'Jumeirah Beach Residence', 'Dubai', 'UAE', 5, 25.2048, 55.2708, 'PrivateBeach,YachtRental,Gym', 'dubai1.jpg,dubai2.jpg', 450.00),
(27, 'London Central Suite', 'Apartment-style accommodations', '21 Baker Street', 'London', 'UK', 4, 51.5074, 0.1278, 'Kitchenette,SelfCheckIn', 'london1.jpg,london2.jpg', 210.00),
(28, 'Sydney Harbour View', 'Iconic views of the Opera House', 'Circular Quay', 'Sydney', 'Australia', 5, -33.8688, 151.2093, 'RooftopPool,Bar,Theater', 'sydney1.jpg,sydney2.jpg', 290.00),
(29, 'Istanbul Grand Bazaar Hotel', 'Traditional Turkish hospitality', 'Sultanahmet Square', 'Istanbul', 'Turkey', 4, 41.0082, 28.9784, 'Hammam,Breakfast,TeaRoom', 'ist1.jpg,ist2.jpg', 140.00),
(30, 'Rio de Janeiro Copacabana', 'Right on the famous beach', 'Av. Atlântica 1000', 'Rio de Janeiro', 'Brazil', 3, -22.9068, -43.1729, 'BeachService,Bar,WiFi', 'rio1.jpg,rio2.jpg', 110.00),
(31, 'Seoul Gangnam Place', 'Business hotel in the upscale district', 'Teheran-ro 25', 'Seoul', 'South Korea', 4, 37.5665, 126.9780, 'BusinessCenter,ConferenceRooms', 'seoul1.jpg,seoul2.jpg', 175.00),
(32, 'Toronto Downtown Hostel', 'Shared rooms and budget travel', '20 Queen Street West', 'Toronto', 'Canada', 2, 43.6532, -79.3832, 'SharedKitchen,Lockers,Lounge', 'toronto1.jpg,toronto2.jpg', 30.00),
(33, 'Cape Town Table View', 'Stunning views of Table Mountain', 'V&A Waterfront', 'Cape Town', 'South Africa', 5, -33.9249, 18.4241, 'Spa,InfinityPool,WineTours', 'capetown1.jpg,capetown2.jpg', 240.00),
(34, 'Berlin Art Hotel', 'Eclectic design and gallery space', 'Oranienburger Straße 1', 'Berlin', 'Germany', 4, 52.5200, 13.4050, 'ArtGallery,Cafe,Bar', 'berlin1.jpg,berlin2.jpg', 155.00),
(35, 'Mexico City Palace', 'Located in the historic centre', 'Avenida Reforma 10', 'Mexico City', 'Mexico', 4, 19.4326, -99.1332, 'RooftopTerrace,Sauna,Pool', 'mexico1.jpg,mexico2.jpg', 180.00),
(36, 'Phnom Penh Diamond', 'Luxury hotel near the Royal Palace', '313 Preah Sisowath Quay', 'Phnom Penh', 'Cambodia', 5, 11.5564, 104.9282, 'Casino,FineDining,Pool', 'pp1.jpg,pp2.jpg', 190.00),
(37, 'San Francisco Bridge View', 'Overlooking the Golden Gate', '1 Pier 39', 'San Francisco', 'USA', 4, 37.7749, -122.4194, 'Balcony,PetFriendly', 'sf1.jpg,sf2.jpg', 205.00),
(38, 'Beijing Hutong Stay', 'Traditional courtyard experience', 'Jingshan Houjie', 'Beijing', 'China', 3, 39.9042, 116.4074, 'TeaHouse,BikeRental,Garden', 'bj1.jpg,bj2.jpg', 75.00),
(39, 'Amsterdam Canal House', 'Boutique hotel in a renovated canal house', 'Keizersgracht 10', 'Amsterdam', 'Netherlands', 4, 52.3702, 4.8952, 'BoutiqueShop,Breakfast', 'ams1.jpg,ams2.jpg', 170.00),
...
(47, 14, 17, 47, 4, N'Phòng đôi tiêu chuẩn ở Thanh Hóa. Vị trí gần biển Sầm Sơn.', N'Lê Thanh Lâm', 'male.png'),
