...
<style>
/* Page background - Đã đổi sang xanh da trời nhạt */
.page-background {
    min-height: 100vh;
...
.modal-title {
    font-size: 2rem;
    font-weight: 800;
    /* Giữ gradient xanh dương cho tiêu đề */
...
.form-input:focus {
    /* Đổi viền focus sang xanh dương */
    border-color: #4facfe;
    outline: none;
...
/* Đổi nút Tiếp tục sang dải màu xanh dương đồng bộ */
.btn-continue {
    width: 100%;
    padding: 14px;
        ...
        <div class="form-container-wrapper">
            <div class="auth-card">
                ...
                <form action="${pageContext.request.contextPath}/register" method="post">
                    <div class="form-group">
                        ...
                        <c:if test="${not empty emailError}">
                            <span style="color: #f56565; font-size: 0.85rem">${emailError}</span>
                        </c:if>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <c:if test="${not empty passwordError}">
                            <span style="color: #f56565; font-size: 0.85rem">${passwordError}</span>
                        </c:if>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <c:if test="${not empty confirmPasswordError}">
                            <span style="color: #f56565; font-size: 0.85rem">${confirmPasswordError}</span>
                        </c:if>
                    </div>
                ...
                <div style="display: flex; justify-content: center; margin-top: 20px;">
                    <a href="${pageContext.request.contextPath}/view/login_error_login.jsp" class="auth-link">
                        Đã có tài khoản? 
                    </a>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <form action="${pageContext.request.contextPath}/login" method="post">
                ...
                <c:if test="${not empty loginError}">
                    <div style="color: #f56565; font-size: 0.85rem; margin-bottom: 10px;">${loginError}</div>
                </c:if>
...
// Mở modal đăng nhập (id này thường nằm ở header)
